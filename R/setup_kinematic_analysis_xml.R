...
#'
#' This function modifies an XML configuration file for kinematic analysis. It updates the XML file with
#' various parameters such as model file, force set files, analysis times, integrator settings, and other
#' configuration parameters. The modified XML file is then saved to the specified setup filename.
#'
#' @param base_file Character string. The path to the base XML file to be modified (default is "setup_ka_base.xml").
...
#' @param step_interval Numeric. The step interval for the kinematic analysis (default is "1").
...
#' @param setup_filename Character string. The name of the XML file to save the modified configuration (default is "setup_ka.xml").
#'
...
#' @import XML
#' @export
setup_kinematic_analysis_xml = function(base_file = "setup_ka_base.xml",
  ...
  ###################   Analysis set, specifics to KA    ###############################
  #start_time
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//Kinematics//start_time")
  XML::xmlValue(nodes[[1]]) = start_time

  #end_time
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//Kinematics//end_time")
  XML::xmlValue(nodes[[1]]) = end_time

  #step_interval
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//Kinematics//step_interval")
  XML::xmlValue(nodes[[1]]) = step_interval

  #in_degrees
  nodes = XML::getNodeSet(x, "//AnalysisSet//objects//Kinematics//in_degrees")
