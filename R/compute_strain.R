...
#'
#' @param length_df_dynamic A data frame containing dynamic muscle length data. Assumes first column is "time".
#' @param length_df_reference A single-row data frame containing reference muscle lengths. Assumes first column is "time".
